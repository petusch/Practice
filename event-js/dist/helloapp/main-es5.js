...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(AppComponent, [{
        ...
        value: function submit(user) {
          ...
          if (this.validate(user)) {
            this.httpService.postData(user).subscribe(function (data) {
              _this.receivedUser = data; // console.log(this.receivedUser);
        ...
        value: function validate(user) {
          if (new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](user.name, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].minLength(3)) != null || new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](user.surname, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].minLength(3)) != null || new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](user.email, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].email) != null || new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](user.password, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].minLength(6)) || new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](user.birthdate, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required)) return false;else return true;
        }
      }]);
    ...
    AppComponent.ɵfac = function AppComponent_Factory(t) {
      return new (t || AppComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_http_service__WEBPACK_IMPORTED_MODULE_3__["HttpService"]));
    };
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 20,
      vars: 8,
      consts: [[1, "image"], [1, "form-group"], ["placeholder", "Name", "name", "username", "minlength", "4", 1, "fn", 3, "ngModel", "ngModelChange"], ["placeholder", "Surname", "name", "surname", "minlength", "4", 1, "fs", 3, "ngModel", "ngModelChange"], ["placeholder", "Mail", "name", "email", "minlength", "4", 1, "fm", 3, "ngModel", "ngModelChange"], ["placeholder", "Password", "name", "password", "minlength", "4", "type", "password", 1, "fp", 3, "ngModel", "ngModelChange"], ["matInput", "", "name", "birthdate", 3, "matDatepicker", "ngModel", "ngModelChange"], ["matSuffix", "", 3, "for"], ["picker", ""], [1, "send", 3, "click"], [4, "ngIf"]],
